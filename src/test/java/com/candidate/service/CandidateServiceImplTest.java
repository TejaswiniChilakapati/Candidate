...
class CandidateServiceImplTest {
	...
	void testAddCandidate() throws Exception {
		...
		Candidate expectedOutput = new Candidate("Rahul Gandhi", "Congress", "UP");
	...
	void testUpdateCandidate() throws Exception {
		...
		Candidate sampleInput = new Candidate("Rahul Gandhi", "Congress", "UP");
		Candidate expectedOutput = new Candidate("Sonia Gandhi", "Congress", "UP");
	...
	void testGetCandidateById() throws Exception {
		Candidate sampleOutput = new Candidate("Rahul Gandhi", "Congress", "UP");
	...
	void testSortingCandidatesBasedOnConstituency() throws Exception {
		Candidate candidate1 = new Candidate("Rahul Gandhi", "Congress", "UP");
		Candidate candidate2 = new Candidate("Modi", "BJP", "Gujarath");
